...
/**
 * This class stands for insertPlateAuthorizationResponse StructType
 * @subpackage Structs
 */
class InsertPlateAuthorizationResponse extends AbstractStructBase
{
    /**
     * The return
    ...
    public $return;
    /**
     * Constructor method for insertPlateAuthorizationResponse
     * @uses InsertPlateAuthorizationResponse::setReturn()
