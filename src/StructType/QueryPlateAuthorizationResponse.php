...
/**
 * This class stands for queryPlateAuthorizationResponse StructType
 * @subpackage Structs
 */
class QueryPlateAuthorizationResponse extends AbstractStructBase
{
    /**
     * The return
    ...
    public $return;
    /**
     * Constructor method for queryPlateAuthorizationResponse
     * @uses QueryPlateAuthorizationResponse::setReturn()
     ...
     * @param \bunge\StructType\RespPlateAuth $return
     * @return \bunge\StructType\QueryPlateAuthorizationResponse
     */
