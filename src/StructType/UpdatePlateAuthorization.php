...
/**
 * This class stands for updatePlateAuthorization StructType
 * @subpackage Structs
 */
class UpdatePlateAuthorization extends AbstractStructBase
{
    /**
     * The company
    ...
    public $dateTo;
    /**
     * The dateFromScheduled
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     * @var string
     */
    public $dateFromScheduled;
    /**
     * The dateToScheduled
     * Meta information extracted from the WSDL
     * - minOccurs: 0
    ...
    public $lstUpd;
    /**
     * Constructor method for updatePlateAuthorization
     * @uses UpdatePlateAuthorization::setCompany()
     * @uses UpdatePlateAuthorization::setIdAuthorization()
     * @uses UpdatePlateAuthorization::setLocation()
     * @uses UpdatePlateAuthorization::setThird()
     * @uses UpdatePlateAuthorization::setThirdVat()
     * @uses UpdatePlateAuthorization::setThirdName()
     * @uses UpdatePlateAuthorization::setDateFrom()
     * @uses UpdatePlateAuthorization::setDateTo()
     * @uses UpdatePlateAuthorization::setDateFromScheduled()
     * @uses UpdatePlateAuthorization::setDateToScheduled()
     * @uses UpdatePlateAuthorization::setProduct()
     * @uses UpdatePlateAuthorization::setProductDesc()
     * @uses UpdatePlateAuthorization::setQuantity()
     * @uses UpdatePlateAuthorization::setUm()
     * @uses UpdatePlateAuthorization::setCarrier()
     * @uses UpdatePlateAuthorization::setAgency()
     * @uses UpdatePlateAuthorization::setPlate1Country()
     * @uses UpdatePlateAuthorization::setPlate1CountryDesc()
     * @uses UpdatePlateAuthorization::setPlate1MeanOfTransport()
     * @uses UpdatePlateAuthorization::setPlate1()
     * @uses UpdatePlateAuthorization::setPlate2Country()
     * @uses UpdatePlateAuthorization::setPlate2CountryDesc()
     * @uses UpdatePlateAuthorization::setPlate2MeanOfTransport()
     * @uses UpdatePlateAuthorization::setPlate2()
     * @uses UpdatePlateAuthorization::setRfrContractThird()
     * @uses UpdatePlateAuthorization::setRfrOrderThird()
     * @uses UpdatePlateAuthorization::setDestinationAddress()
     * @uses UpdatePlateAuthorization::setContactPhone()
     * @uses UpdatePlateAuthorization::setDestinationTimetable()
     * @uses UpdatePlateAuthorization::setAwardeeName()
     * @uses UpdatePlateAuthorization::setAwardeeAddress()
     * @uses UpdatePlateAuthorization::setAwardeeCode()
     * @uses UpdatePlateAuthorization::setAwardeeCountry()
     * @uses UpdatePlateAuthorization::setAwardeeCountryDesc()
     * @uses UpdatePlateAuthorization::setAwardeeProvince()
     * @uses UpdatePlateAuthorization::setAwardeeProvinceDesc()
     * @uses UpdatePlateAuthorization::setAwardeeCity()
     * @uses UpdatePlateAuthorization::setObs()
     * @uses UpdatePlateAuthorization::setObsWaybillNote()
     * @uses UpdatePlateAuthorization::setFlexiTare()
     * @uses UpdatePlateAuthorization::setFlexiContainer()
     * @uses UpdatePlateAuthorization::setFlexiBookNumber()
     * @uses UpdatePlateAuthorization::setTankType()
     * @uses UpdatePlateAuthorization::setDriverId()
     * @uses UpdatePlateAuthorization::setDriverIdCountry()
     * @uses UpdatePlateAuthorization::setDriverIdCountryDesc()
     * @uses UpdatePlateAuthorization::setDriverName()
     * @uses UpdatePlateAuthorization::setSwtSample()
     * @uses UpdatePlateAuthorization::setPriceTransport()
     * @uses UpdatePlateAuthorization::setCurrencyPrice()
     * @uses UpdatePlateAuthorization::setUmPrice()
     * @uses UpdatePlateAuthorization::setAct()
     * @uses UpdatePlateAuthorization::setListContracts()
     * @uses UpdatePlateAuthorization::setListStockTransferOrders()
     * @uses UpdatePlateAuthorization::setWhoContractsTransport()
     * @uses UpdatePlateAuthorization::setLstUpd()
     * @param float $company
     * @param float $idAuthorization
     ...
     * @param string $dateTo
     * @param string $dateFromScheduled
     * @param string $dateToScheduled
     ...
     * @param string $lstUpd
     */
    public function __construct($company = null, $idAuthorization = null, $location = null, $third = null, $thirdVat = null, $thirdName = null, $dateFrom = null, $dateTo = null, $dateFromScheduled = null, $dateToScheduled = null, $product = null, $productDesc = null, $quantity = null, $um = null, \bunge\StructType\RespPlateAuthTransporter $carrier = null, \bunge\StructType\RespPlateAuthTransporter $agency = null, $plate1Country = null, $plate1CountryDesc = null, $plate1MeanOfTransport = null, $plate1 = null, $plate2Country = null, $plate2CountryDesc = null, $plate2MeanOfTransport = null, $plate2 = null, $rfrContractThird = null, $rfrOrderThird = null, $destinationAddress = null, $contactPhone = null, $destinationTimetable = null, $awardeeName = null, $awardeeAddress = null, $awardeeCode = null, $awardeeCountry = null, $awardeeCountryDesc = null, $awardeeProvince = null, $awardeeProvinceDesc = null, $awardeeCity = null, $obs = null, $obsWaybillNote = null, $flexiTare = null, $flexiContainer = null, $flexiBookNumber = null, $tankType = null, $driverId = null, $driverIdCountry = null, $driverIdCountryDesc = null, $driverName = null, $swtSample = null, $priceTransport = null, $currencyPrice = null, $umPrice = null, $act = null, array $listContracts = array(), array $listStockTransferOrders = array(), $whoContractsTransport = null, $lstUpd = null)
    {
        $this
            ->setCompany($company)
            ->setIdAuthorization($idAuthorization)
            ...
            ->setDateTo($dateTo)
            ->setDateFromScheduled($dateFromScheduled)
            ->setDateToScheduled($dateToScheduled)
            ->setProduct($product)
     ...
     * @param float $company
     * @return \bunge\StructType\UpdatePlateAuthorization
     */
    ...
    {
        return isset($this->idAuthorization) ? $this->idAuthorization : null;
    }
    /**
     ...
     * @return \bunge\StructType\UpdatePlateAuthorization
     */
    public function setIdAuthorization($idAuthorization = null)
    {
        // validation for constraint: float
        if (!is_null($idAuthorization) && !(is_float($idAuthorization) || is_numeric($idAuthorization))) {
            throw new \InvalidArgumentException(sprintf('Invalid value %s, please provide a float value, %s given', var_export($idAuthorization, true), gettype($idAuthorization)), __LINE__);
        }
        if (is_null($idAuthorization) || (is_array($idAuthorization) && empty($idAuthorization))) {
            unset($this->idAuthorization);
        } else {
    ...
    /**
     * Get dateFromScheduled value
     * An additional test has been added (isset) before returning the property value as
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return string|null
     */
    public function getDateFromScheduled()
    {
        return isset($this->dateFromScheduled) ? $this->dateFromScheduled : null;
    }
    /**
     * Set dateFromScheduled value
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @param string $dateFromScheduled
     * @return \bunge\StructType\UpdatePlateAuthorization
     */
    public function setDateFromScheduled($dateFromScheduled = null)
    {
        // validation for constraint: string
        if (!is_null($dateFromScheduled) && !is_string($dateFromScheduled)) {
            throw new \InvalidArgumentException(sprintf('Invalid value %s, please provide a string, %s given', var_export($dateFromScheduled, true), gettype($dateFromScheduled)), __LINE__);
        }
        if (is_null($dateFromScheduled) || (is_array($dateFromScheduled) && empty($dateFromScheduled))) {
            unset($this->dateFromScheduled);
        } else {
            $this->dateFromScheduled = $dateFromScheduled;
        }
        return $this;
    }
    /**
     * Get dateToScheduled value
     * An additional test has been added (isset) before returning the property value as
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return string|null
     */
    public function getDateToScheduled()
    {
        return isset($this->dateToScheduled) ? $this->dateToScheduled : null;
    }
    /**
     * Set dateToScheduled value
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @param string $dateToScheduled
     * @return \bunge\StructType\UpdatePlateAuthorization
     */
    public function setDateToScheduled($dateToScheduled = null)
    {
        // validation for constraint: string
        if (!is_null($dateToScheduled) && !is_string($dateToScheduled)) {
            throw new \InvalidArgumentException(sprintf('Invalid value %s, please provide a string, %s given', var_export($dateToScheduled, true), gettype($dateToScheduled)), __LINE__);
        }
        if (is_null($dateToScheduled) || (is_array($dateToScheduled) && empty($dateToScheduled))) {
            unset($this->dateToScheduled);
        } else {
            $this->dateToScheduled = $dateToScheduled;
        }
        return $this;
    }
    /**
    ...
    public static function validateListContractsForArrayConstraintsFromSetListContracts(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $updatePlateAuthorizationListContractsItem) {
            // validation for constraint: itemType
            if (!$updatePlateAuthorizationListContractsItem instanceof \bunge\StructType\RespPlateAuthContract) {
                $invalidValues[] = is_object($updatePlateAuthorizationListContractsItem) ? get_class($updatePlateAuthorizationListContractsItem) : sprintf('%s(%s)', gettype($updatePlateAuthorizationListContractsItem), var_export($updatePlateAuthorizationListContractsItem, true));
            }
        }
    ...
    public static function validateListStockTransferOrdersForArrayConstraintsFromSetListStockTransferOrders(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $updatePlateAuthorizationListStockTransferOrdersItem) {
            // validation for constraint: itemType
            if (!$updatePlateAuthorizationListStockTransferOrdersItem instanceof \bunge\StructType\RespPlateAuthStockTransferOrder) {
                $invalidValues[] = is_object($updatePlateAuthorizationListStockTransferOrdersItem) ? get_class($updatePlateAuthorizationListStockTransferOrdersItem) : sprintf('%s(%s)', gettype($updatePlateAuthorizationListStockTransferOrdersItem), var_export($updatePlateAuthorizationListStockTransferOrdersItem, true));
            }
        }
        if (!empty($invalidValues)) {
     ...
     * @return string|null
     */
    public function getLstUpd()
    {
        return isset($this->lstUpd) ? $this->lstUpd : null;
    }
    /**
     * Set lstUpd value
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     ...
     * @return \bunge\StructType\UpdatePlateAuthorization
     */
    public function setLstUpd($lstUpd = null)
    {
        // validation for constraint: string
        if (!is_null($lstUpd) && !is_string($lstUpd)) {
            throw new \InvalidArgumentException(sprintf('Invalid value %s, please provide a string, %s given', var_export($lstUpd, true), gettype($lstUpd)), __LINE__);
        }
        if (is_null($lstUpd) || (is_array($lstUpd) && empty($lstUpd))) {
            unset($this->lstUpd);
        } else {
            $this->lstUpd = $lstUpd;
        }
